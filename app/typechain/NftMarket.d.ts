...
interface NftMarketInterface extends ethers.utils.Interface {
  ...
  events: {
    ...
    "nft_Created(uint256,string,address,address,uint256,bool)": EventFragment;
    "nft_Sale(uint256,address,bool)": EventFragment;
  };
...
export class NftMarket extends BaseContract {
  ...
  filters: {
    ...
    nft_Sale(
      ...
      { tokenID: BigNumber; newOwner: string; sold: boolean }
    >;
  };
